...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            // KSoup dependency for common code
            ...
            // Add Kotlinx Coroutines for async support
...
android {
    namespace = "com.devtutorial.richlinks"
    ...
    defaultConfig {
        applicationId = "com.devtutorial.richlinks"
...
compose.desktop {
    application {
        mainClass = "com.devtutorial.richlinks.MainKt"
